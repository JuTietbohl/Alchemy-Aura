    ...
    public class HomeController : Controller
    {
        public IActionResult Index()
        {
            ...
            var potions = new List<Potion>
            {
                ...
                new Potion { Id = 7, Name = "Morph Potion", Description = "Transform into whoever or whatever you want by Fulla.", Price = 8.00m, ImageUrl = "/images/stink_bomb_potion.png" },
                new Potion { Id = 8, Name = "Invisibility Potion", Description = "Renders the drinker completely unseen by J. Shivinski.", Price = 75.00m, ImageUrl = "/images/invisibility_potion.png" },
                ...
                new Potion { Id = 11,Name = "Gomu No Mi Potion", Description = "Stretch your bones by Pedrita.", Price = 102.00m, ImageUrl = "/images/gomu_no_mi_potion.jpeg" },
